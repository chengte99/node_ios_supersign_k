...
RESIGNED_IPA_PATH="./"$IPA_NAME"/"$PROVISIONING_FILE".ipa"
echo $IPA_PATH
...
./ios_resign_with_ipa $IPA_PATH "$CERT_NAME" $ORI_PROVISIONING_PATH $RESIGNED_IPA_PATH $PROVISIONING_FILE $IPA_NAME
